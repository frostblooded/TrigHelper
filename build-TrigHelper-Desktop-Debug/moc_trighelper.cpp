...
static const char qt_meta_stringdata_TrigHelper[] = {
    "TrigHelper\0\0on_calculate_button_clicked()\0"
};
...
const QMetaObjectExtraData TrigHelper::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TrigHelper::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TrigHelper,
      qt_meta_data_TrigHelper, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TrigHelper::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TrigHelper))
